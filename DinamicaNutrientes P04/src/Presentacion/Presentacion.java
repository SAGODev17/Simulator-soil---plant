...
public class Presentacion extends Consola {
	...
	public ParametroNP capturarParametroNP(Nutriente pNutriente, Planta pPlanta) {
		...
		this.presentarEncabezado();
		rParametroNP.velocidadAbsorcion = this.capturarDatoFlotante("Velocidad de absorción " + rParametroNP.nutriente.simbolo + " - " + rParametroNP.planta.nombre + " [u/t]: ");
		this.presentarCierreSeccion();
		return rParametroNP;
	}
	...
	public ParametroNS capturarParametroNS(Nutriente pNutriente, Suelo pSuelo) {
		...
		this.presentarEncabezado();
		rParametroNS.velocidadPrecipitacion = this.capturarDatoFlotante("Velocidad de precipitación " + rParametroNS.nutriente.simbolo + " - " + rParametroNS.suelo.nombre + " [u/t]: ");
		this.presentarCierreSeccion();
		return rParametroNS;
	}
	
	public RelacionNNP capturarRelacionNNP(Nutriente pNutriente1, Nutriente pNutriente2, Planta pPlanta) {
		RelacionNNP rRelacionNNP;
		rRelacionNNP = new RelacionNNP(pNutriente1, pNutriente2, pPlanta);
		rRelacionNNP.nutriente1 = pNutriente1;
		rRelacionNNP.nutriente2 = pNutriente2;
		rRelacionNNP.planta = pPlanta;
		this.seccionPrincipal = "Captura de relaciones óptimas Nutriente/Nutriente - Planta";
		this.presentarEncabezado();
		rRelacionNNP.numeradorOptimo = this.capturarDatoFlotante("Numerador óptimo " + rRelacionNNP.nutriente1.simbolo + " / " + rRelacionNNP.nutriente2.simbolo + " - " + rRelacionNNP.planta.nombre + ": ");
		rRelacionNNP.denominadorOptimo = this.capturarDatoFlotante("Denominador óptimo " + rRelacionNNP.nutriente1.simbolo + " / " + rRelacionNNP.nutriente2.simbolo + " - " + rRelacionNNP.planta.nombre + ": ");
		this.presentarCierreSeccion();
		return rRelacionNNP;
	}
